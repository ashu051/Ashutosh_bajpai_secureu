...
with open('unvalid_certificate.txt', 'w') as f:
    for line in not_valid_cer:
        f.write(f"{line}\n")
# print("*"*100+"XSS Header List"+"*"*100)
# for i in xss_header_check:
#     print(i)
import pyfiglet
import sys
import socket
...
try:
    ...
    # will scan ports between 1 to 250
...
#     conn = create_custom_HTTPSConnection('google.com')
#     conn.request('GET', '/')
...
# |    |\    \'  |    | |    ||    |\    \ |    | |    |   |      \ |    ||    | |    ||    |   ____ |    |\    \ 
# |    | \    \  |    | |    ||    | |    ||    | |    |   |    |\ \|    ||    | |    ||    |  |    ||    | |    |
# |____|  \____\ |____|/____/||____| |____||____| |____|   |____||\_____/||\___\_|____||\ ___\/    /||____| |____|
# |    |   |    ||    /    | ||    | |    ||    | |    |   |    |/ \|   ||| |    |    || |   /____/ ||    | |    |
# |____|   |____||____|____|/ |____| |____||____| |____|   |____|   |___|/ \|____|____| \|___|    | /|____| |____|
#                                                                                            |____|/               """)
# print("\n*************************************************")
# print("\n* Twitter : https://twitter.com/UcarKadirhan    *")
# print("\n* GitHub : https://github.com/kdrhnucr          *")
# print("\n*************************************************")
# print ("")
